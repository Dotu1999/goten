...
<div class="container-fluid">
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="menu" >
	  <ul class="navbar-nav">
	  	<li class="nav-item">
	      <a class="nav-link" style="margin-top: -2px;" href="#">
...
<div class="container" id="content">
	<div class="incontent">
		...
		<div class="row">
		  <div class="col-sm-3">
		  	...
		  	<p>Lịch thi tuyển sinh đào tạo trình độ thạc sỹ năm 2019</p>
		  </div>
		  <div class="col-sm-3">
		  	<img  " src="./img/lichhoc.jpg">
		  	<p>Lịch học ôn thi tuyển sinh thạc sỹ năm 2019</p>
		  </div>
		  <div class="col-sm-3">
		  	<img  " src="./img/danh_muc.jpg" style="height: 170px;">
		  	<p>Thông báo các môn thi trong tuyển sinh đào tạo.</p>
		  </div>
		  <div class="col-sm-3">
		  	<ul style="margin-top: 20px;">
		  		<li>Lịch học chuyển đổi thi tuyển sinh cao học năm...</li>
		  		<li>Thông báo tuyển sinh liên thông trình độ đại học...</li>
		  		<li>Quyết định điểm chuẩn tuyển sinh năm học 2019 cơ sơ mở rộng...</li>
		  		<li>Quyết định điểm chuẩn tuyển sinh năm học 2019 Trương Đại Học Thủy Lợi...</li>
		  	</ul>
		  </div>
		</div>
	</div>
	<div class="incontent">
		...
		<div class="row">
		  <div class="col-sm-3">
		  	<img  " src="./img/danh_muc.jpg" style="height:170px;">
		  	<p>Thông báo về kế hoạch học kỳ 2 năm học 2019-2020...</p>
		  </div>
		  <div class="col-sm-3">
		  	<img  " src="./img/danh_muc.jpg" style="height: 170px;">
		  	<p>Thông báo về kế hoạch học kỳ 2 năm học 2019-2020...</p>
		  ...
		  <div class="col-sm-3">
		  	<img  " src="./img/lichthi.jpg">
		  	<p>Thông báo các thi chuẩn đầu ra Tiếng Anh A2...</p>
		  </div>
		  <div class="col-sm-3">
		  	<ul style="margin-top: 20px;">
		  		<li>Lễ tốt nghiệp và trao bằng tiến sĩ, thạc sĩ đợt 2...</li>
		  		<li>Thông báo về kế hoạch học kỳ 2 năm học 2019-2020</li>
		  		<li>Thông tin thời gian bảo vệ luận án tiến sĩ cấp...</li>
		  		<li>Thông tin thời gian bảo vệ luận án tiến sĩ cấp...</li>
		  	</ul>
		  </div>
		</div>
	...
	<div class="incontent">
		...
		<div class="row">
		  ...
		  <div class="col-sm-3">
		  	<ul style="margin-top: 20px;">
		  		<li>Trường Đại học Thủy lợi mở rộng hợp tác đào tạo...</li>
		  		<li>Hợp tác phát triển Phòng Thí Nghiệm Công Nghiệp...</li>
		  		<li>Đẩy mạnh hợp tác với các doanh nghiệp Nhật Bản</li>
		  		<li>Thông báo học bổng ITEC Ấn Độ năm 2019-2020</li>
		  	</ul>
		  </div>
		</div>
	</div>
