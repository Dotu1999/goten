...
<div class="container-fluid">
	...
	<div class="row" id="content">
		...
		<!-- Nội dung từng mục -->
  		<div class="col-sm-10" style="background-color: #f1f1f1">
  			<form class="teacher" action="../create_account_gv.php" method="POST">
  				<div class="row">
  					<div class="col-sm-2">Tên giảng viên</div>
	  				<div class="col-sm-2"><input type="text" name="name"></div>
	  				<div class="col-sm-2">Mã GV</div>
	  				<div class="col-sm-2"><input type="text" name="ma_gv"></div>
	  				<div class="col-sm-2">Số ĐT</div>
	  				<div class="col-sm-2"><input type="text" name="sodt"></div>
  				</div><br>
  				<div class="row">
  					<div class="col-sm-2">Tuổi</div>
	  				<div class="col-sm-2"><input type="text" name="tuoi"></div>
  			...
  			<form class="search">
				  ...
				  <input type="text" class="form-control" placeholder="Nhập Mã Giảng Viên">
	...
	<div class="change_teacher">
		<form>
			<div class="row">
  					<div class="col-sm-3">Tên giảng viên</div>
	  				<div class="col-sm-3"><input type="text" name="name"></div><br>
	  				<div class="col-sm-3">Mã GV</div>
	  				<div class="col-sm-3"><input type="text" name="ma_gv"></div>
	  		</div>
	  		<div class="row">
	  				<div class="col-sm-3">Số ĐT</div>
	  				<div class="col-sm-3"><input type="text" name="sodt"></div>
  					<div class="col-sm-3">Tuổi</div>
	  				<div class="col-sm-3"><input type="text" name="tuoi"></div>
	  		</div><br>
	  		<div class="row">
	  				<div class="col-sm-3">Email</div>
	  				<div class="col-sm-3"><input type="text" name="email"></div>
	  				<div class="col-sm-3">Password</div>
	  				<div class="col-sm-3"><input type="text" name="password"></div>
  			</div><br>
