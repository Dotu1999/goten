	...
	<div class="row" id="content">
		...
		<!-- Nội dung từng mục -->
  			...
  			<div class="majors" style="flex-grow: 1;margin-top: 20px;">
  				...
  				<?php
	                ...
	                foreach ($result as $row) {
	                	echo '<a href="#" class="list-group-item list-group-item-action list-group-item-dark">'.$row['name'].'</a>';
	                }
	            ?>
				    <!-- <a href="#" class="list-group-item list-group-item-action list-group-item-dark">Tin Đại Cương</a>
				    <a href="#" class="list-group-item list-group-item-action list-group-item-dark">Toán Xác Xuất</a>
				    <a href="#" class="list-group-item list-group-item-action list-group-item-dark">Mạng Máy tính</a> -->
				  </div>
  			</div>
  		...
  		<div class="col-sm-7" style="background-color: #FFFFFF;display: flex;flex-direction: column;">
			...
			<div class="create_subjects" style="height: 40px;margin-bottom: 20px;">
